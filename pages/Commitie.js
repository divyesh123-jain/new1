...
const committie = () => {
  ...
  <div class="py-8 px-4  max-w-screen-xl sm:py-16 lg:px-6 mx-7">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-gray-900 dark:text-white">Committee</h2>

          <div class="border-b-4 border-indigo-500 ..."></div>
          <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-gray-900 dark:text-white"> Chief Patrons</h2>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              <div class="flex justify-center items-center mb-4  rounded-full dark:bg-primary-900">
                  <Image src={chairman} alt=""  className='w-[30vh]'/>
              </div>
          ...
          <div>
              ...
              <Image src={vc} alt=""  className='w-[30vh]'/>
              </div>
  ...
  <div class="py-8 px-4 mx-7 max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-gray-900 dark:text-white">Patrons</h2>
          <div class="border-b-4 border-indigo-500 ..."></div>
      </div>
